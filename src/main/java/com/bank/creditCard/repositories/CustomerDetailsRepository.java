...
public interface CustomerDetailsRepository extends JpaRepository<CustomerDetails, Long>{
	...
	public Optional<CustomerDetails>  findCustomerDetailsByPanCardNumber(@Param("panCardNumber") String panCardNumber);

	@Query (value = "SELECT * FROM CUSTOMER_DETAILS WHERE USER_ID IN :userIds ", nativeQuery =  true)
	public List<CustomerDetails> findCustomerDetailsByUserIds(@Param("userIds") Set<Long>  customerUserIds); 
