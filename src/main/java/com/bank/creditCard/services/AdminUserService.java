...
public class AdminUserService {
	...
	/**
	 * This method with interacts with {@link CreditCardRequestService} layer and get all {@link CardRequestDetails} waiting for Approval<br>
	 * <p>This is an asynchronous method. When a resource module invoke this method, it will run on separate thread and performs all activities in the method.
	 * When multiple requests try to invoke this method, this method will run in multiple threads asynchronously with out latency </p> 
	 * @return It will return List of {@link CardRequestDetails} binded in {@link CompletableFuture} 
	 * @throws InterruptedException When Asynchronous thread is interrupted while it's waiting, sleeping
	 */
	@Async("asyncExecutor")
	 ...
	 * @return On successful status update it will {@link CardRequestDetails} with updated status details
	 * @throws DataNotFound When no {@link CardRequestDetails} found for the requestId
	 * @throws InvalidRequestException When an invalid status id is tried to updated for a {@link CardRequestDetails}
	 */
	@Transactional
	...
	/**
	 * This method used to get a {@link CardRequestDetails} along with the {@link CustomerDetails}
	 * @param requestId  Request Id in {@link CardRequestDetails}
	 * @return {@link CardRequestDetails} binded with {@link CustomerDetails}
	 * @throws DataNotFound When {@link CardRequestDetails} are not for the requestId
	 */
