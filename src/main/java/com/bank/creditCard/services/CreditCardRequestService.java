...
/**
 * 
 * This service class will interact with repository layer and perform business activities like <br>
 * 1. Get Available Credit Cards from using repository
 * 2. Get Individual Credit Card details and its offer details
 * 2. Validate new Credit Card request
 * 3. Save Credit Card Request and create Customer
 *
 */
@Service
public class CreditCardRequestService {
	...
	/**
	 * This method is used to validate the {@link CreditCardRequestDetails} and Save the {@link CardRequestDetails} along with creating a {@link CustomerDetails} 
	 * @param creditCardRequestDetails Credit Card request details are binded in {@link CreditCardRequestDetails}
	 ...
	 * @throws DeficientException When Customer salary is insufficient to get a credit card
	 * @throws DataNotFound When request {@link CreditCardName} is not found 
	 */
	@Transactional
	...
	/**
	 * This method will interacts with a repository to find {@link CardRequestDetails} which are in a particular status
	...
	/**
	 * This method will update the status of a credit card request with a statusId and status message
	...
	/**
	 * This method will filter a requested {@link CreditCardName} details and based on requested location details it identify the appropriate {@link CreditCardOffers} details object and bind to {@link CreditCardName}    
	 ...
	 * @throws DataNotFound When {@link CreditCardName} is not found for the requested cardId
	 */
