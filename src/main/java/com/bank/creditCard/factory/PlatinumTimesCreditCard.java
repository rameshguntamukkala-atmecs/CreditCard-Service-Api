...
/**
 * 
 * This method will calculate the RewardPoints for the PlatinumTimes credit card
...
@Setter
@NoArgsConstructor
public class PlatinumTimesCreditCard implements RewardPointsCalculator {
 ...
 public PlatinumTimesCreditCard(Map<String, Double> properties) {
