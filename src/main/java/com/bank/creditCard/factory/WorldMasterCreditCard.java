...
/**
 * 
 * This method will calculate the RewardPoints for the WorldMaster credit card
...
@Setter
@NoArgsConstructor
public class WorldMasterCreditCard implements RewardPointsCalculator {
 ...
 public WorldMasterCreditCard(Map<String, Double> properties) {
