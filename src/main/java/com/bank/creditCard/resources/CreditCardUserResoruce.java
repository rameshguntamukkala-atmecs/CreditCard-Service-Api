...
/**
 * 
 * This is a resource class where up-steam application request for credit card user request services like <br>
...
public class CreditCardUserResoruce {
	...
	public ResponseEntity<ServiceResponse> getUserDetails(@PathVariable Long userId) throws DataNotFound{
	 ...
	 * @param userId userId of a Customer
	 * @param customerDetails {@link RequestBody} serialize to {@link CustomerDetails}
	 * @return updated {@link CustomerDetails} binded in {@link ResponseEntity}
	 * @throws DataNotFound When Customer is not found for userId
	 * @throws InvalidRequestException When Primary data like FirstName, LastName, PAN Number are updated.
	 */
	 ...
	 * @param userId userId of a Customer
	 * @return List of {@link CreditCardDetails} are binded to {@link ResponseEntity}
	 */
