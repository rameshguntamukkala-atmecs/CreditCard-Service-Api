...
/**
 * 
 * This is a resource class where the up-steam application requests Admin user services like <br>
...
public class AdminUserResource {
	...
	/**
	 * This method will return the list of credit card requests waiting for approval 
	 ...
	 * @throws InterruptedException When Async Service Thread is interrupted while it's waiting, sleeping
	 * @throws ExecutionException When Async services are failed
	 * @throws DataNotFound When {@link CardRequestDetails} not for the requestId
	 */
	 ...
	 * @return {@link CardRequestDetails} with status message is binded in {@link ResponseEntity}
